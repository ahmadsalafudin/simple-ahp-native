...
<html>
    <head>
        <meta charset="UTF-8">
        <title>PT KAYU PERMATA| Edit Nilai Alternatif</title>
                        ...
                        <div class="col-md-6">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Update Nilai ALternatif</h3>                                    
                                </div>
								<?php
									include('config.php');
                                ...
                                <form role="form" method="post" action="upd.php?id=<?php echo $_GET['id'];?>"> 
                                    <div class="box-body">
